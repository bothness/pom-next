import { c as create_ssr_component, g as getContext, a as subscribe, e as escape, b as add_attribute, v as validate_component, f as add_styles } from './index3-85f631df.js';
import { b as base } from './paths-05fee424.js';
import { S as Select_1 } from './Select-0e299020.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  $$unsubscribe_rtl();
  return `${$$result.head += `<!-- HEAD_svelte-ypvg3j_START -->${$$result.title = `<title>${escape($t("Palestine Open Maps"))}</title>`, ""}<meta property="og:title"${add_attribute("content", $t("Palestine Open Maps"), 0)}><!-- HEAD_svelte-ypvg3j_END -->`, ""}

<h1 class="svelte-15v3o4w"><!-- HTML_TAG_START -->${$t("Welcome to<br>Palestine Open Maps")}<!-- HTML_TAG_END --></h1>
...
//# sourceMappingURL=_page.svelte-5f0a9304.js.map
