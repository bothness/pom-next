import { c as create_ssr_component, g as getContext, a as subscribe, f as add_styles, v as validate_component, i as createEventDispatcher, e as escape, b as add_attribute, m as missing_component, j as spread, k as escape_object, l as escape_attribute_value, h as each, o as globals } from './index3-85f631df.js';
...
const css = {
  code: "#search.svelte-1du1ice{width:100%;height:50px;margin-top:1px;background-color:white;--height:50px;--borderRadius:0px}.search-rtl.svelte-1du1ice{left:auto !important;right:50px}.search-rtl .indicator{right:auto !important;left:10px}",
  map: null
};
const Select_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_rtl();
  $$unsubscribe_t();
  return `<div id="search" class="${["svelte-1du1ice", $rtl ? "search-rtl" : ""].join(" ").trim()}"${add_styles({
...
//# sourceMappingURL=Select-0e299020.js.map
